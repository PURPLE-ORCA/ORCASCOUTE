...
export const KanbanBoard = ({ id, children, className }: KanbanBoardProps) => {
  ...
  return (
    <div
      className={cn(
        "flex size-full min-h-40 flex-col divide-y overflow-hidden rounded-md border bg-primary-foreground/40 text-xs shadow-sm ring-2 transition-all",
  ...
  return (
    <KanbanContext.Provider value={{ columns, data, activeCardId }}>
      ...
      >
        <div
          className={cn(
            "grid size-full auto-cols-[minmax(300px,1fr)] grid-flow-col gap-4 overflow-x-auto pb-4",
            className
          )}
        >
